        ...
        <div className="flex items-center gap-2">
          <Link href={`/list/teachers/${item.id}`}>
            <button
              ...
              title="View"
              aria-label="View"
              className="w-7 h-7 flex items-center justify-center rounded-full bg-sky-300"
            >
        ...
        <div className="flex flex-col md:flex-row items-center gap-4 w-full md:w-auto">
          ...
          <div className="flex items-center gap-4 self-end">
            <button
              ...
              title="Filter"
              aria-label="Filter"
              className="w-8 h-8 flex items-center justify-center rounded-full bg-sky-300"
            >
            ...
            {role === "admin" && (
              ...
              //     aria-label="Add"
              //   >
              //</div>     <Image src="/plus.png" alt="" width={14} height={14} />
              //   </button>
